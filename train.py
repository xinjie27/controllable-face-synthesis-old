...
def main(**kwargs):
    ...
    c.G_kwargs = dnnlib.EasyDict(class_name=None, z_dim=64, w_dim=512, mapping_kwargs=dnnlib.EasyDict())
    ...
    c.G_kwargs.gbuffer_channels = 9 # Color 3, Texture 3, Norm 3, Vertex 3
