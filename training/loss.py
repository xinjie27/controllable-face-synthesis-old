...
class StyleGAN2Loss:
    ...
    def run_G(self, z, m, c, update_emas=False):
        ...
        img = self.G.synthesis(m, ws, update_emas=update_emas)
        return img, ws
    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_m, gen_c, gain, cur_nimg):
        ...
        if phase in ['Gmain', 'Gboth']:
            with torch.autograd.profiler.record_function('Gmain_forward'):
                gen_img, _gen_ws = self.run_G(gen_z, gen_m, gen_c)
        ...
        if phase in ['Dmain', 'Dboth']:
            with torch.autograd.profiler.record_function('Dgen_forward'):
                gen_img, _gen_ws = self.run_G(gen_z, gen_m, gen_c, update_emas=True)
